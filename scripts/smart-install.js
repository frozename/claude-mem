 ...
 * 3. XDG path (~/.config/claude/plugins/marketplaces/frozename)
 * 4. Legacy path (~/.claude/plugins/marketplaces/frozename)
 */
function resolveRoot() {
  ...
  const marketplaceRel = join('plugins', 'marketplaces', 'frozename');
